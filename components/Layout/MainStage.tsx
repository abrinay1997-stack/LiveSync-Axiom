             ...
             <div className="flex flex-col gap-1">
                ...
                <div className="flex items-center bg-white/5 border border-white/10 rounded-lg px-3 py-1.5 gap-3 hover:border-white/20 transition-colors">
                   ...
                   <input 
                     ...
                     className="w-24 h-1 bg-slate-800 rounded-full appearance-none accent-amber-500"
                   />
                   <div className="bg-amber-500/10 px-2 py-0.5 rounded border border-amber-500/20">
                      <span className="text-[11px] font-black mono text-amber-500 text-center">+{config.visualGain}dB</span>
                   </div>
                </div>
             </div>
          </div>
          ...
          <div className="flex flex-col gap-1 shrink-0">
             ...
             <div className="flex items-center gap-3">
                <button 
                    ...
                    disabled={!isStarted}
                    className="flex items-center gap-2 px-5 py-2 rounded-lg bg-cyan-500/10 border border-cyan-500/30 text-[10px] font-black text-cyan-400 hover:bg-cyan-500 hover:text-black transition-all disabled:opacity-20"
                >
                    <Activity size={14} /> FIND DELAY
                </button>
                {analysis.delayData && (
                  <div className="flex items-center gap-3 px-4 py-2 bg-black border border-white/10 rounded-lg">
